...
import { analyticsService } from 'features/services';
import { routesConfiguration, ScopeType, LayoutType, RoutePath } from '_app/routes';
...
import 'features/resources/user/user.handlers';
